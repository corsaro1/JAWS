...
Public Class Lisk
    ...
    Private Sub Button2_Click(sender As System.Object, e As System.EventArgs)
        ...
        request = DirectCast(WebRequest.Create("http://wallet.shift.4miners.net:8000/api/loader/status/sync"), HttpWebRequest)
    ...
    Private Sub Form1_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        ...
        Label18.Text = "and STAKE your SHIFT voting too for some SHIFT pools"
        ...
        pRegKey = pRegKey.OpenSubKey("SOFTWARE\jaws")
        ...
        If RadioButton1.Checked = True Then
            url1 = "https://wallet.shiftnrg.org/"

        End If
        If RadioButton2.Checked = True Then
            url1 = "https://wallet.shift.4miners.net/"
    ...
    Private Sub Button2_Click_2(sender As System.Object, e As System.EventArgs) Handles Button2.Click
        ...
        Dim url As String = "https://wallet.shiftnrg.org/api/transactions"

        If RadioButton1.Checked = True Then
            url = "https://wallet.shiftnrg.org/api/transactions"


        End If
        If RadioButton2.Checked = True Then
            url = "https://wallet.shift.4miners.net/api/transactions"
        ...
        Try
            ...
            If Regex.IsMatch(original, "^[0-9 ]+$") Then
                If post = "" Then
                    ...
                    MsgBox(original & ",00" & " SHIFT will be sent")

                Else

                    MsgBox(original & "," & post & " SHIFT will be sent")
...
FooError:
    ...
    Private Sub Button4_Click(sender As System.Object, e As System.EventArgs) Handles Button4.Click
        ...
        Dim newkey As RegistryKey = key.CreateSubKey("jaws")
...
fooerror:
    ...
    Private Sub Button8_Click(sender As System.Object, e As System.EventArgs) Handles Button8.Click
        System.Net.ServicePointManager.SecurityProtocol = SecurityProtocolType.Tls12
        Dim url As String = "https://wallet.shiftnrg.org/api/accounts/delegates"

        If RadioButton1.Checked = True Then
            url = "https://wallet.shiftnrg.org/api/accounts/delegates"


        End If
        If RadioButton2.Checked = True Then
            url = "https://wallet.shift.4miners.net/api/accounts/delegates"
        ...
        request = DirectCast(WebRequest.Create("https://wallet.shiftnrg.org/api/accounts/delegates/?address=" & senderId), HttpWebRequest)
        response = DirectCast(request.GetResponse(), HttpWebResponse)
        reader = New StreamReader(response.GetResponseStream())
...
fooerror:
    ...
    Private Sub BackgroundWorker1_DoWork_1(sender As System.Object, e As System.ComponentModel.DoWorkEventArgs) Handles BackgroundWorker1.DoWork
        ...
        request = DirectCast(WebRequest.Create("https://wallet.shiftnrg.org/api/loader/status/sync"), HttpWebRequest)
    ...
    Private Sub BackgroundWorker2_DoWork(sender As System.Object, e As System.ComponentModel.DoWorkEventArgs) Handles BackgroundWorker2.DoWork
        ...
        On Error Resume Next
        request = DirectCast(WebRequest.Create("https://wallet.shift.4miners.net/api/loader/status/sync"), HttpWebRequest)
        'request = DirectCast(WebRequest.Create("https://wallet.shiftnrg.org/api/loader/status/sync"), HttpWebRequest)
    ...
    Private Sub Button17_Click(sender As System.Object, e As System.EventArgs) Handles Button17.Click
        ...
        Dim url As String = "https://wallet.shiftnrg.org/api/multisignatures/sign"

        If RadioButton1.Checked = True Then
            url = "https://wallet.shiftnrg.org/api/multisignatures/sign"


        End If
        If RadioButton2.Checked = True Then
            url = "https://wallet.shift.4miners.net/api/multisignatures/sign"
...
Fooerror2:
    ...
    Private Sub Button21_Click(sender As System.Object, e As System.EventArgs) Handles Button21.Click
        ...
        ElseIf result = DialogResult.Yes Then
            ...
            'request = DirectCast(WebRequest.Create("https://wallet.shiftnrg.org/api/accounts?address=" & senderid2), HttpWebRequest)
        End If
...
fooerror:
    ...
    Private Sub Button24_Click(sender As Object, e As EventArgs) Handles Button24.Click
        ...
        Dim url As String = "https://wallet.shiftnrg.org/api/delegates"

        If RadioButton1.Checked = True Then
            url = "https://wallet.shiftnrg.org/api/accounts/open"


        End If
        If RadioButton2.Checked = True Then
            url = "https://wallet.shift.4miners.net/api/accounts/open"
        ...
        Else
            MsgBox("Secret has been saved on your PC. Kindly make different copies of this file to not lost your SHIFT in case of hdd failure")
        End If
...
fooerror:
    ...
    Private Sub Button26_Click(sender As Object, e As EventArgs) Handles Button26.Click
        System.Net.ServicePointManager.SecurityProtocol = SecurityProtocolType.Tls12
        If MsgBox("With this procedure you will associate a delegate name to your address and will cost 25 SHIFT", MsgBoxStyle.OkCancel, "Title") = MsgBoxResult.Ok Then
...
fooerror:
    ...
    Private Sub Button27_Click(sender As Object, e As EventArgs) Handles Button27.Click
        ...
        If RadioButton1.Checked = True Then
            url = "https://wallet.shiftnrg.org/api/delegates"


        End If
        If RadioButton2.Checked = True Then
            url = "https://wallet.shift.4miners.net/api/delegates"
