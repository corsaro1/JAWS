...
Public Class pubkeyForm
    ...
    Private Sub Button1_Click(sender As System.Object, e As System.EventArgs) Handles Button1.Click
        ...
        If RadioButton1.Checked = True Then
            ' url = "https://wallet.shiftnrg.org/api/multisignatures/"
            ...
            If Lisk.RadioButton2.Checked = True Then
                url = "https://wallet.shift.4miners.net/api/multisignatures/"
        ...
        Else
            url = "https://wallet.testnet.shiftnrg.org/api/multisignatures/"
        End If
